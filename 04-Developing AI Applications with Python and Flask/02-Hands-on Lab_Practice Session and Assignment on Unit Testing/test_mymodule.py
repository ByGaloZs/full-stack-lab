...
# Define a test class for testing the "add" function.
class TestAdd(unittest.TestCase):
    ...
    def test1(self):
        ...
        )  # Test  "hello" and world are given as input the output must be "helloworld".
        ...
        )  # Test  2.3000 and 4.300 are given as input the output must be 6.6.

        # Check that  calling "add(-2, -2)" returns != 0.
        # This tests if the function correctly computes the sum of -2 and -2
        self.assertNotEqual(
            add(-2, -2), 0
        )  # Test  -2 and -2 are given as input the output must not be 0.
